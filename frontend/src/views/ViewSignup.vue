        ...
        <div class="row">
            ...
            <form class=" form mx-lg-auto d-flex flex-column gap-3 col-lg-7 col-md-12 col-ms-12">
                <div class="form-floating">
                    ...
                    <label for="name" class="form-label">Escriba su nombre</label>
                </div>
                <div class="form-floating">
                ...
                <div class="form-floating">
                    <input type="password" class="form-control" id="password" placeholder="">
                    <label for="password" class="form-label">Repita su contraseña</label>
                </div>
                <div class="text-end">
                    <button class="btn btn-success" @click="">Registrarse</button>
                </div>
            </form>
        </div>
    </div>
